// =============================================
// GameVault Backend — Geliştirilmiş Sürüm
// =============================================
...
// =============================================
// KULLANICI: KOD YÜKLEME (bakiye ekle)
// =============================================
...
// =============================================
// KULLANICI: STEAM KODU ÇEK (max 5 kere)
// =============================================
app.post("/api/get-steam-code", async (req, res) => {
  ...
  if (purchase.steamCodeRequests >= 5) {
    return res.json({
      success: false,
      message: "Maksimum doğrulama talebi aşıldı (5/5).",
      limitReached: true
    });
  }
  ...
  try {
    ...
    if (!steamCode) {
      return res.json({
        success: false,
        message: "Kod henüz gelmedi. 30 saniye sonra tekrar dene.",
        requestsLeft: 5 - purchase.steamCodeRequests
      });
    }
    ...
    res.json({
      success: true,
      steamCode,
      steamUser: purchase.steamUser,
      steamPass: purchase.steamPass,
      requestsLeft: 5 - purchase.steamCodeRequests
    });
  } catch (err) {
...
// =============================================
// ADMIN: TÜM KULLANICILARI GÖRÜNTÜLE
// =============================================
...
// =============================================
// ADMIN: KULLANICI BAKİYE GÜNCELLE
// =============================================
...
// =============================================
// ADMIN: TÜM SATIN ALMALARI GÖRÜNTÜLE
// =============================================
...
// =============================================
// ADMIN: OYUNLARI DETAYLI GÖRÜNTÜLE
// =============================================
